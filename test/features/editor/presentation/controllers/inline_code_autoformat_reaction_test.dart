...
import 'package:my_notion/features/editor/presentation/controllers/inline_code_autoformat_reaction.dart';
import 'package:super_editor/super_editor.dart';

void main() {
  group('InlineCodeAutoformatReaction.react', () {
    ...
    const reaction = InlineCodeAutoformatReaction();
    ...
    test('no-op when caret is mid-span (no closing backtick yet)', () {
      composer.setSelectionWithReason(
        const DocumentSelection.collapsed(
          position: DocumentPosition(
            nodeId: 'p1',
