    ...
    switch (kind) {
      ...
      case QuillToastKind.success:
        return const _BannerColors(
          fg: Color(0xFF9BBF9F),
          bg: Color(0x295A8F6E), // rgba(90,143,110,0.16)
          border: Color(0xFF5A8F6E),
        );
      case QuillToastKind.warn:
        return const _BannerColors(
          fg: Color(0xFFD7C896),
          bg: Color(0x29C4A548), // rgba(196,165,72,0.16)
          border: Color(0xFFC4A548),
        );
      case QuillToastKind.error:
        return const _BannerColors(
          fg: Color(0xFFD6A39B),
          bg: Color(0x29A8584C), // rgba(168,88,76,0.16)
          border: Color(0xFFA8584C),
        );
    }
  }
  switch (kind) {
    ...
    case QuillToastKind.success:
      return const _BannerColors(
        fg: Color(0xFF3F6E54),
        bg: Color(0x1A5A8F6E), // rgba(90,143,110,0.10)
        border: Color(0xFF5A8F6E),
      );
    case QuillToastKind.warn:
      return const _BannerColors(
        fg: Color(0xFF806020),
        bg: Color(0x24C4A548), // rgba(196,165,72,0.14)
        border: Color(0xFFC4A548),
      );
    case QuillToastKind.error:
      return const _BannerColors(
        fg: Color(0xFF7E3D33),
        bg: Color(0x1AA8584C), // rgba(168,88,76,0.10)
        border: Color(0xFFA8584C),
      );
  }
}
