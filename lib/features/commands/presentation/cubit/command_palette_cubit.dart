...
class CommandPaletteCubit extends Cubit<CommandPaletteState> {
  ...
  static const _baseActions = <CommandEntry>[
    ...
    CommandEntry(group: CommandGroup.actions, icon: 'sync', label: 'Open random page', hint: '⌘⇧O'),
    ...
    CommandEntry(group: CommandGroup.actions, icon: 'note', label: 'Show duplicate page titles', hint: ''),
    CommandEntry(group: CommandGroup.actions, icon: 'note', label: 'Show heaviest pages', hint: ''),
    ...
    CommandEntry(group: CommandGroup.actions, icon: 'tag', label: 'Open random untagged page', hint: ''),
    ...
    CommandEntry(group: CommandGroup.actions, icon: 'table', label: 'Import Asana CSV as database', hint: ''),
    CommandEntry(group: CommandGroup.actions, icon: 'note', label: 'Import Evernote .enex notebook', hint: ''),
    CommandEntry(group: CommandGroup.actions, icon: 'note', label: 'Import Word .docx as page', hint: ''),
