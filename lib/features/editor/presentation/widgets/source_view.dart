...
class _SourceViewState extends State<SourceView> {
  ...
  Future<void> _onSlashPick(SlashEntry entry) async {
    ...
    switch (entry.action) {
      ...
      case SlashAction.insertIsoYearWeek:
        final snippet = formatIsoYearWeek(DateTime.now());
        final newText = text.replaceRange(stripStart, caret, snippet);
        _controller.value = TextEditingValue(
          text: newText,
          selection:
      ...
      case SlashAction.sentenceCaseSelectedLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, sentenceCaseLinesIn,
        );
      case SlashAction.swapCaseSelectedLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.asciiOnlyLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, asciiOnlyLinesIn,
        );
      ...
      case SlashAction.stripHtmlTagsLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, stripHtmlTagsLinesIn,
        );
      case SlashAction.prefixLinesWithIndex:
        _applyLinesTransformAfterSlash(
          stripStart, caret, prefixLinesWithIndexIn,
        );
      case SlashAction.stripLeadingNumberPrefix:
        _applyLinesTransformAfterSlash(
          stripStart, caret, stripLeadingNumberPrefixIn,
        );
      case SlashAction.splitLinesOnSentences:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.stripEmojiLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.escapeMarkdownLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, escapeMarkdownLinesIn,
        );
      case SlashAction.prefixLinesWithCharCount:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.prefixLinesWithWordCount:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.addBlockquotePrefix:
        _applyLinesTransformAfterSlash(
          stripStart, caret, addBlockquotePrefixIn,
        );
      case SlashAction.trimBlankEdgeLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, trimBlankEdgeLinesIn,
        );
      case SlashAction.dedentLines:
        _applyLinesTransformAfterSlash(stripStart, caret, dedentLinesIn);
      case SlashAction.stripHeadingMarker:
        _applyLinesTransformAfterSlash(
          stripStart, caret, stripHeadingMarkerLinesIn,
        );
      ...
      case SlashAction.smartTypography:
      ...
      case SlashAction.sortLinesByFirstNumber:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.sortLinesBySumOfNumbers:
        _applyLinesTransformAfterSlash(
          stripStart, caret, sortLinesBySumOfNumbersIn,
        );
      case SlashAction.sortLinesByMaxNumber:
        _applyLinesTransformAfterSlash(
          stripStart, caret, sortLinesByMaxNumberIn,
        );
      case SlashAction.sortLinesByMinNumber:
        _applyLinesTransformAfterSlash(
          stripStart, caret, sortLinesByMinNumberIn,
        );
      case SlashAction.sortLinesByMedianNumber:
        _applyLinesTransformAfterSlash(
          stripStart, caret, sortLinesByMedianNumberIn,
        );
      case SlashAction.extractNumbersFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractNumbersFromLinesIn,
        );
      case SlashAction.extractEmailsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractMentionsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.splitOnSpaces:
        _applyLinesTransformAfterSlash(
          stripStart, caret, splitOnSpacesIn,
        );
      case SlashAction.extractOpenTodoBodies:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractIsoDatesFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractHexColorsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractTcpUdpPortsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractTcpUdpPortsFromLinesIn,
        );
      ...
      case SlashAction.extractMacAddressesFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMacAddressesFromLinesIn,
        );
      case SlashAction.extractMarkdownCodeSpansFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractMarkdownListContentFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMarkdownListContentFromLinesIn,
        );
      case SlashAction.extractMarkdownStrikethroughFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMarkdownStrikethroughFromLinesIn,
        );
      case SlashAction.extractMarkdownCodeFenceLangsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMarkdownCodeFenceLangsFromLinesIn,
        );
      case SlashAction.extractMarkdownBoldFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMarkdownBoldFromLinesIn,
        );
      case SlashAction.extractMarkdownItalicFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMarkdownItalicFromLinesIn,
        );
      case SlashAction.extractMarkdownFootnoteIdsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMarkdownFootnoteIdsFromLinesIn,
        );
      case SlashAction.extractMarkdownFootnoteBodiesFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMarkdownFootnoteBodiesFromLinesIn,
        );
      case SlashAction.extractBareUrlsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractBareUrlsFromLinesIn,
        );
      case SlashAction.extractYearsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractYearsFromLinesIn,
        );
      case SlashAction.extractMarkdownAutolinksFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMarkdownAutolinksFromLinesIn,
        );
      case SlashAction.extractHtmlTagsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractHtmlTagsFromLinesIn,
        );
      case SlashAction.extractHtmlAttributeNamesFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractMarkdownReferenceLinkUsageLabelsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret,
      ...
      case SlashAction.extractEmailDomainsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractYoutubeIdsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractDoiFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractDoiFromLinesIn,
        );
      case SlashAction.extractFileExtensionsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractFileExtensionsFromLinesIn,
        );
      case SlashAction.extractIsbn13FromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractIsbn13FromLinesIn,
        );
      case SlashAction.extractJiraTicketsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractJiraTicketsFromLinesIn,
        );
      case SlashAction.extractPrIssueRefsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractPrIssueRefsFromLinesIn,
        );
      case SlashAction.extractRomanNumeralsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractEthAddressesFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractAwsArnsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractGithubIssuePrNumbersFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractStackOverflowQuestionIdsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret,
      ...
      case SlashAction.extractHslColorsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractHtmlEntitiesFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractHtmlEntitiesFromLinesIn,
        );
      case SlashAction.extractMarkdownTaskStatesFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMarkdownTaskStatesFromLinesIn,
        );
      case SlashAction.extractSlackMentionsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractMimeTypesFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractMimeTypesFromLinesIn,
        );
      case SlashAction.extractKubernetesResourcesFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractCronExpressionsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractEthereumAddressesFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractEthereumAddressesFromLinesIn,
        );
      case SlashAction.extractGeoCoordinatesFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractDoisFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractDoisFromLinesIn,
        );
      case SlashAction.extractLinuxSignalsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractLinuxSignalsFromLinesIn,
        );
      case SlashAction.extractEnvVarsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractEnvVarsFromLinesIn,
        );
      case SlashAction.extractIpv6FromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractIpv6FromLinesIn,
        );
      case SlashAction.extractIsbn10FromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractIsbn10FromLinesIn,
        );
      case SlashAction.extractIssnFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractSha256FromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractStackTraceRefsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractStackTraceRefsFromLinesIn,
        );
      case SlashAction.extractStripeIdsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractStripeIdsFromLinesIn,
        );
      case SlashAction.extractDmsCoordinatesFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, extractDmsCoordinatesFromLinesIn,
        );
      ...
      case SlashAction.extractGitShasFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.canonicalizeHorizontalRules:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractMarkdownReferenceLinkLabelsFromLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret,
          extractMarkdownReferenceLinkLabelsFromLinesIn,
        );
      case SlashAction.extractMarkdownTableCellsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.extractMarkdownLinkUrlsFromLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.constantCaseLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.italicLines:
        _applyLinesTransformAfterSlash(stripStart, caret, italicLinesIn);
      case SlashAction.codeLines:
        _applyLinesTransformAfterSlash(stripStart, caret, codeLinesIn);
      case SlashAction.strikethroughLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, strikethroughLinesIn,
        );
      ...
      case SlashAction.markdownTableToCsv:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.linesToJsonArray:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.medianNumericLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, medianNumericLinesIn,
        );
      ...
      case SlashAction.deltaNumericLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, deltaNumericLinesIn,
        );
      case SlashAction.cumulativeProductLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, cumulativeProductLinesIn,
        );
      ...
      case SlashAction.varianceNumericLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, varianceNumericLinesIn,
        );
      case SlashAction.zScoreNumericLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, zScoreNumericLinesIn,
        );
      case SlashAction.normalizeNumericLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.floorNumericLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, floorNumericLinesIn,
        );
      case SlashAction.ceilNumericLines:
        _applyLinesTransformAfterSlash(
          stripStart, caret, ceilNumericLinesIn,
        );
      case SlashAction.truncateNumericLines:
        _applyLinesTransformAfterSlash(
      ...
      case SlashAction.withThousandSeparatorsLines:
        _applyLinesTransformAfterSlash(
