/// Pure-Dart detector for the `~~X~~` strikethrough autoformat trigger.
/// Symmetric in shape to [detectBoldAutoformat]; only the marker char
/// changes (`~` vs `*`).
///
/// Contract:
...
({int markerStart, int markerEnd, String inner})? detectStrikeAutoformat({
