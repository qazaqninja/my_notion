...
- 🚧 Sub-grouping — M86 BoardView, M177 TableView (frozen + scrollable panes share unified entry stream). Gallery / Timeline / List / Calendar / Chart still 📋.
...
- 🚧 Group and sub-group per view — Group ✅. Sub-group BoardView M86, TableView M177. Other views 📋.
