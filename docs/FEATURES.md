...
- 🚧 Sub-grouping — M86 BoardView, M177 TableView, M183 GalleryView, M184 ListView (section header with row count per cluster). Timeline / Calendar / Chart still 📋.
...
- 🚧 Group and sub-group per view — Group ✅. Sub-group BoardView M86, TableView M177, GalleryView M183, ListView M184. Timeline / Calendar / Chart 📋.
