...
String _renderUnlockForm(String ulid, {String? error}) {
  ...
  return '<!doctype html><meta charset="utf-8">'
      ...
      'input[type=password]{flex:1;padding:.5em;'
      'border:1px solid #ddd;border-radius:4px;font:inherit}'
      'button{padding:.5em 1em;border:0;border-radius:4px;'
...
String _renderHtml(String markdown) {
  ...
  return '<!doctype html><meta charset="utf-8">'
      ...
      'blockquote{border-left:3px solid #ddd;margin:1em 0;'
      'padding:.25em 0 .25em 1em;color:#555}'
      'a{color:#3071a9}'
